...
class TablaProductos{
  ...
  public function mostrarTablaProductos(){	
  	...
  	$datosJson = '
	 	...
	 	for($i = 0; $i < count($productos); $i++){//traia despues del count un -1
			...
			TRAER MULTIMEDIA
  			...
  			if($productos[$i]["multimedia"] != null){
  				...
  				if($multimedia[0]["foto"] != ""){
  					...
  					$vistaMultimedia = "<img src='https://cdn.icon-icons.com/icons2/491/PNG/512/video-clip-3_47857.png' class='img-thumbnail imgTablaMultimedia' width='100px'>";
