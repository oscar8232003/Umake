...
<head>
	...
	<link rel="stylesheet" href="<?php echo $url; ?>vistas/css/curso.css">
...
if(isset($_GET["ruta"])){
	...
	}else if($rutas[0] == "buscador" || $rutas[0] == "verificar" || $rutas[0] == "salir" || $rutas[0] == "perfil" || $rutas[0] == "carrito-de-compras" || $rutas[0] == "error" || $rutas[0] == "finalizar-compra" || $rutas[0] == "curso" || $rutas[0] == "ofertas" || $rutas[0] == "curso-reproductor"){
