								...
								echo '<div class="panel panel-default">
									    ...
									    <div class="panel-body">
											...
											<div class="col-sm-6 col-xs-12">
												...
												<h1 class="titulo-perfil"><small>'.$value2["titulo"].'</small></h1>
										...
										<div class="btn-group pull-right">
											...
											if($value2["tipo"] == "virtual" && $value2["precio"] != 0){
												...
												if($value2["oferta"] != 0){
													...
													echo '<button type="button" class="btn btn-default btn-xs agregarCarrito"  idProducto="'.$value2["id"].'" imagen="'.$url.$value2["portada"].'" titulo="'.$value2["titulo"].'" precio="'.$value2["precio"].'" tipo="'.$value2["tipo"].'" peso="'.$value2["peso"].'" data-toggle="tooltip" title="Agregar al carrito de compras">
