		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 col-xs-12 text-left infoContacto">
				...
				<h5>
					...
					<i class="fa fa-phone-square" aria-hidden="true"></i> xxxxxxxxx

					<br><br>

					<i class="fa fa-envelope" aria-hidden="true"></i> soporte@umake.com

					<br><br>

					<i class="fa fa-map-marker" aria-hidden="true"></i> Jose Miguel Carrera 1997
