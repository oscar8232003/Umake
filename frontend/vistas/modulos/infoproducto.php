				...
				if($infoproducto["tipo"] == "fisico"){
					...
					echo '<div class="col-md-5 col-sm-6 col-xs-12 visorImg">
							...
							for($i = 0; $i < count($multimedia); $i ++){
								...
								echo '<li>
							     	<img value="'.($i+1).'" class="img-thumbnail" src="'.$url.$multimedia[$i]["foto"].'" alt="'.$infoproducto["titulo"].'">
							    </li>';
					...
					echo '<div class="col-sm-6 col-xs-12">
						...
						<video id="my-video" class="video-js embed-responsive-item videoPresentacion" controls preload="auto" data-setup="{}">
					    		<source src="'.$infoproducto["multimedia"].'" type="video/mp4">
					  		</video>
						...
						if($infoproducto["tipo"]=="virtual"){
							...
							echo '</div>
								...
								<div class="col-md-6 col-xs-12">
									...
									<button class="btn btn-default btn-block btn-lg backColor agregarCarrito"  idProducto="'.$infoproducto["id"].'" imagen="'.$url.$infoproducto["portada"].'" titulo="'.$infoproducto["titulo"].'" precio="'.$infoproducto["precio"].'" tipo="'.$infoproducto["tipo"].'" peso="'.$infoproducto["peso"].'">
				      ...
				      <div class="panel-heading text-uppercase">
				      	...
				      	if($usuario["modo"] == "directo"){
				      		...
				      		if($usuario["foto"] == ""){
				      			...
				      			echo '<img class="img-circle pull-right" src="'.$url.'vistas/img/usuarios/default/anonymous.png" width="20%">';	
